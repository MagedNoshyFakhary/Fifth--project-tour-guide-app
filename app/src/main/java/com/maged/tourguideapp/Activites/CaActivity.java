...
import com.maged.tourguideapp.Adaptors.CaPagerAdapter;
import com.maged.tourguideapp.R;

public class CaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        caPagerAdapter =new CaPagerAdapter(getSupportFragmentManager(), FragmentPagerAdapter
                .BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT,tabLayout.getTabCount());
        viewPager.setAdapter(caPagerAdapter);
